    ...
    <section class="py-10 sm:py-16 bg-white">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div x-data="{ openPanel: null }" class="space-y-3 sm:space-y-4">
                @php
                    $faqs = [
                        ['q' => 'What payment methods do you accept?', 'a' => 'We accept credit/debit cards (Visa, Mastercard), Ozow Instant EFT, and EFT/bank transfers. For bulk orders, we also offer invoice-based payment terms for approved businesses. Payments are processed securely through Ozow.'],
                        ...
                        ['q' => 'Do you deliver nationwide?', 'a' => 'Yes! We deliver nationwide across South Africa. Shipping rates vary by location — main centres (Gauteng, Cape Town, Durban) are R150 flat rate, and regional areas are R250 flat rate. Contact us for a quote to remote areas.'],
                        ['q' => 'What is your warranty policy?', 'a' => 'All products come with a comprehensive warranty covering manufacturing defects. Extended warranty options are available on select products. The warranty does not cover damage from misuse, unauthorized modifications, physical damage, or normal wear and tear. Consumable items like cables and batteries are not covered.'],
