        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div>
                    ...
                    <p class="text-gray-600 mb-8">Have a question, need technical assistance, or want a custom quote? We're here to help.</p>
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">Midrand, Gauteng<br>South Africa</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600 mt-1">info@dennyexpress.co.za</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 p-4 bg-gray-50 rounded-xl">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-900">Phone / WhatsApp</h3>
                                <p class="text-gray-600 mt-1">074 355 1336</p>
                            </div>
                        </div>
                    ...
                    <div class="mt-8 flex flex-col sm:flex-row gap-4">
                        <a href="https://wa.me/27743551336" target="_blank" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-primary text-white font-semibold rounded-xl hover:bg-primary-dark transition-colors">
                        ...
                        <a href="tel:0743551336" class="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gray-100 text-gray-900 font-semibold rounded-xl hover:bg-gray-200 transition-colors border border-gray-200">
                    ...
                    <form class="space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Your name">
                            </div>
                            <div>
                        ...
                        <div>
                            ...
                            <input type="tel" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Your phone number">
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-900 mb-1">Message *</label>
                            <textarea rows="5" class="w-full px-4 py-3 bg-white border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all" placeholder="Tell us more about your enquiry..."></textarea>
                        </div>
