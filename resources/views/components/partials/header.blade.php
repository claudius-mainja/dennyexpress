        ...
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="flex items-center gap-2 lg:gap-3">
                ...
                <a href="{{ route('wishlist.index') }}" class="group hidden sm:inline-flex p-2 text-gray-500 hover:text-primary transition-colors relative" aria-label="Wishlist">
                    ...
                    <span x-show="wishlistCount > 0" class="absolute -top-0.5 -right-0.5 w-4 h-4 bg-red-500 text-white text-[10px] font-bold rounded-full flex items-center justify-center" x-text="wishlistCount"></span>
