    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16 lg:h-20">
            ...
            <div class="flex items-center gap-2 lg:gap-3">
                <button @click="searchOpen = !searchOpen" class="p-2 text-gray-500 hover:text-gray-900 transition-colors" aria-label="Search">
                ...
                @auth
                    <a href="{{ route('dashboard') }}" class="hidden sm:inline-flex p-2 text-gray-500 hover:text-gray-900 transition-colors" aria-label="Account">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </a>
                @else
                    <a href="{{ route('login') }}" class="hidden sm:inline-flex p-2 text-gray-500 hover:text-gray-900 transition-colors" aria-label="Sign in">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                        </svg>
                    </a>
                ...
                <a href="{{ route('wishlist.index') }}" class="hidden sm:inline-flex p-2 text-gray-500 hover:text-gray-900 transition-colors relative" aria-label="Wishlist">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <button @click="cartOpen = !cartOpen" class="p-2 text-gray-500 hover:text-gray-900 transition-colors relative" aria-label="Cart">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
