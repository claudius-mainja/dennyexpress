<div x-show="cartOpen"
     ...
     x-cloak>
    <div @click="cartOpen = false" class="absolute inset-0 bg-black/50 backdrop-blur-sm"></div>
    <div x-show="cartOpen"
         x-transition:enter="transition ease-out duration-300"
        ...
        <div class="flex items-center justify-between p-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Shopping Cart ({{ $count }})</h2>
            <button @click="cartOpen = false" class="p-2 text-gray-500 hover:text-gray-900 transition-colors">
                ...
                <div class="space-y-4">
                    @foreach ($items as $item)
                        <div class="flex items-start gap-3 pb-4 border-b border-gray-100">
                            <div class="w-16 h-16 rounded-lg bg-gray-50 overflow-hidden shrink-0 border border-gray-200">
